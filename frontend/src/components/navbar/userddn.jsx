    ...
    return (
        <>
            ...
            {isOpen && <>
                ...
                <div ref={ddnRef} className="z-100 text-left w-30 absolute top-13 right-2 backdrop-blur-sm rounded-md bg-gradient-to-r from-teal-50/95 to-green-50/70 text-green-700 border-2 border-green-700/80 shadow-md shadow-teal-700/20">
                    <ul className="w-full">
                        <div className="flex-col">
                            <Link className="block hover:bg-gradient-to-r hover:from-green-600/95 hover:to-green-500/85 hover:text-white w-full p-1 px-3"
                                to={"/profile/" + user.id} onClick={() => setIsOpen(false)} >
                                Profile
                            </Link>
                            <Link className="block hover:bg-gradient-to-r hover:from-green-600/95 hover:to-green-500/85 hover:text-white w-full p-1 px-3"
                                to={"/settings/"} onClick={() => setIsOpen(false)} >
                                Settings
                            </Link>
                        </div>
